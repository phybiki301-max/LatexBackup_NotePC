...
\subsection{理想気体}
    質量$m$の独立な$N$個の自由粒子
    \begin{definition}[状態数]
        \begin{equation*}
            W = = \frac{3N}{2E} \left( \left( \frac{em}{3 \pi \hbar^2} \right)^{\frac{3}{2}} \left( \frac{E}{N} \right)^{\frac{3}{2}} V \right)^{N}
        \end{equation*}
    \end{definition}
    \begin{derivationBox}
        自由粒子理想気体のハミルトニアンは
        \begin{align}
            \hat{H} = \sum_{n=1}^N \frac{1}{2m} \hat{\bm{p}}_n^2 \notag
        \end{align}
        である。エネルギー固有値は
        \begin{align}
        ...
        \end{align}
        したがって系の状態数$\Omega$は半径$\sqrt{E/\epsilon}$の$3N$次元球内の格子点の数と近似できる。n次元球の体積$V_n$の公式
        \begin{align}
            V_n = \frac{\pi^{\frac{n}{2}}}{\Gamma\left(\frac{n}{2}+1\right)} 
        \end{align}
        と(nが十分大きいときに成り立つ)Stirlingの公式
        \begin{align}
            n! \approx \left( \frac{n}{e} \right)^n
        \end{align}
        を用いると$n$が十分大きいとき、3N次元球の体積は
        \begin{align}
            V_{3N} = \frac{\pi^{\frac{3N}{2}}}{\Gamma\left(\frac{3N}{2}+1\right)} \approx \frac{\pi^{\frac{3N}{2}}}{\left(\frac{3N}{2}\right)!} \sim \pi^{\frac{3N}{2}} \left( \frac{2e}{3N} \right)^{\frac{3N}{2}}
        \end{align}
        となる。よって状態数は
        \begin{align}
            \Omega &\sim \frac{1}{2^{3N}} \left( \sqrt{\frac{E}{\epsilon}} \right)^{3N} V_{3N}\notag \\
            &\sim \frac{1}{2^{3N}} \left( \sqrt{\frac{E}{\epsilon}} \right)^{3N} \pi^{\frac{3N}{2}} \left( \frac{2e}{3N} \right)^{\frac{3N}{2}}\notag \\
            &= \frac{1}{4^{\frac{3N}{2}}} \left( \frac{E}{\epsilon} \right)^{\frac{3N}{2}}  \left( \frac{2\pi e}{3N} \right)^{\frac{3N}{2}} \notag \\
