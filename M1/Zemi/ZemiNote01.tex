...
\subsection{多体問題のSchrödinger方程式}
    ...
    \begin{align}
        &i\hbar \frac{\partial}{\partial t} \Psi(\bm{r}_1,\cdots,\bm{r_N;t}) = \hat{H} \Psi(\bm{r}_1,\cdots,\bm{r_N;t}) \label{NryuShiSyuredi}\\
    ...
    \begin{align}
        \Psi(\bm{r}_1,\cdots, \bm{r}_i,\cdots \bm{r}_j,\cdots,\bm{r_N;t}) &= \Psi(\bm{r}_1,\cdots, \bm{r}_j,\cdots \bm{r}_i,\cdots,\bm{r_N;t}) \label{BoseTaisyouKansu} \\
        \Psi(\bm{r}_1,\cdots, \bm{r}_i,\cdots \bm{r}_j,\cdots,\bm{r_N;t}) &= -\Psi(\bm{r}_1,\cdots, \bm{r}_j,\cdots \bm{r}_i,\cdots,\bm{r_N;t})\label{FermiTaisyouKansu}
    \end{align}
...
\subsection{完全対象関数と完全反対称関数}
    ...
    \begin{align}
        \Psi_{\textbf{Bose}}(\bm{r}_1,\cdots,\bm{r}_N) = \sum_{P} \Psi(\bm{r}_{P1},\cdots,\bm{r}_{PN})
    \end{align}
    と書ける。\footnote{ここでは波動関数の規格化定数は無視する}Fermionの波動関数は
    \begin{align}
        \Psi_{\textbf{Fermi}}(\bm{r}_1,\cdots,\bm{r}_N) = \sum_{P} (-1)^P\Psi(\bm{r}_{P1},\cdots,\bm{r}_{PN})
    \end{align}
    ...
    \begin{align}
        \Psi_{\textbf{Fermi}}(\bm{r}_1,\cdots,\bm{r}_N) = \sum_{P}(-1)^P \phi_1(\bm{r}_{P1})\phi_2(\bm{r}_{P2})\cdots\phi_N(\bm{r}_{PN})
    \end{align}
    となり、さらに行列式の定義より
    \begin{align}
        =\textrm{det} 
...
\subsection{第二量子化への準備}
    ...
    \begin{align}
        ...
        \{ \hat{\psi}(\bm{r}),\hat{\psi}^\dagger(\bm{r}') \}  &= \delta(\bm{r}-\bm{r}')
    \end{align}
\end{document}